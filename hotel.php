...
<div class="w3-main" style="margin-left:290px">
  <div class="w3-display-container w3-container">
	...
	<h1>Students by a room</h1>

	<form class="w3-form" method="post">
	<?php
		$sth = $dbh->prepare('select roomNumber from room');
		$sth->execute();
	...
	<?php
		if(isset($_POST['formCom']) ) {
			...
			echo "<h3>List of students staying in room  ".$userInput."</h3>";
			$sth = $dbh->prepare("select fName, lName from attendee where aID in (  select aID from student where student.roomNumber = \"$userInput\")");
			$sth->execute();
